...
var mapOuterSize=[960,475]; // width, height
var mapMaxZoom=4;
...
var legendMargin=[10,7,10,7]; // top, right, bottom, left
...
.attr("viewBox", "0 0 " + mapOuterSize[0] + " " + mapOuterSize[1] )
...
function ready(error, us, coast) {
	...
	.attr("y", mapSize[1] - 15)
	.text("*1784 borders used for colonial era");
